    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_customer_header">
          <!--begin::Modal title-->
          <h2 class="fw-bolder">أضف مستخدم</h2>
          <!--end::Modal title-->
  ...
  setup() {
    ...
    const rules = ref({
      ...
      password_confirmation: [
        {
          required: true,
          message: "Customer password_confirmation is required",
          trigger: "change",
        },
      ],
      roles: [
        {
          required: true,
          message: "Customer roles is required",
          trigger: "change",
        },
      ],
    });
    ...
    const submit = async () => {
      ...
      console.log("formData", formData.name);
          ...
          if(formData.password !== formData.password_confirmation){
             Swal.fire({
            text: "Sorry, password_confirmation must like password plze ",
            icon: "error",
    ...
    const requestFun = async () =>{
      loading.value = true;
       try{
           await store.dispatch(Actions.ADD_ADMIN ,{
              name: formData.name,
