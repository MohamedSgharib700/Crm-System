...
export default defineComponent({
  name: "Users-listing",
  props:['id_branch','id_detailes_pos_user','namepage'],
...
setup(props){
    ...
    const Branches = informations.branches.find((branche) => branche.id == props.id_branch);
    const showAllDetailes = Branches.pos_users.find((branche) => branche.id == props.id_detailes_pos_user);
    ...
    onMounted(()=>{
      ...
      setCurrentPageBreadcrumbs("الشركات", [
        "/companies/commercial_register",
          "قائمه سجل التجارى",
        "تفاصيل الفروع","تفاصيل حساب نقاط البيع","تفاصيل"]);
      }
