<template>
  <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <!--begin::Card body-->
    <div class="card-body">
      <div class="data" v-if="nameDetaiels == 'manager'">
        <!--begin::Row-->
        <div class="row">
          <!--begin::Label-->
...
export default defineComponent({
  ...
  setup(props) {
    ...
    let informations = computed(() => store.getters.GetBranches);
    const information = informations.value.find(
      (branche) => branche.id == props.idbranches
    );
